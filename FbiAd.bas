...
'Dim Data(0 To 4) As Integer
'Dim SmplChReq(0 To 4) As ADSMPLCHREQ
...
Public Function TempRdMoldTop!()
Dim flg As Long
'Dim dt!(0 To 4)
Dim dt!(0 To 7)
  AdRead dt(), flg
  TempRdMoldTop = dt(0) * 1000# / 10#    '上モールド温度=V*(1000℃/10V)
'  TempRdMoldTop = dt(4) * 1500 / 10  '放射温度計 300-1300
End Function
