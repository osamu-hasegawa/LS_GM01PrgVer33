...
'    For ch = 1 To 5
    For ch = 1 To 8
      'hdt = AdRead1Ch(Ch)
      Select Case ch
      Case 1     'AD(Ch1):è„ÉÇÅ[ÉãÉh
        hdt = dt(ch - 1) * 1000 / 10 'TempRdMoldTop()
